...
class Game:
    ...
    def update(self):
        self.display.fill((204, 153, 255))

        for skin in self.snake:
            pygame.draw.rect(self.display,  (255, 255, 255), pygame.Rect(skin.x, skin.y, BLOCK_SIZE, BLOCK_SIZE))
            pygame.draw.rect(self.display, (0, 255, 0), pygame.Rect(skin.x + 4, skin.y + 4, 12, 12))
